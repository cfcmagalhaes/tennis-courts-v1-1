...
public class CustomResponseEntityExceptionHandler extends ResponseEntityExceptionHandler
{
	...
	return buildResponseEntity( new ErrorDetails( LocalDateTime.now( ), error, ex.getLocalizedMessage( ) ),
			BAD_REQUEST );
    }
	...
	return buildResponseEntity(
			new ErrorDetails( LocalDateTime.now( ), builder.substring( 0, builder.length( ) - 2 ),
